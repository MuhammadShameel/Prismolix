      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-24 left-0 w-full z-[100] px-3 md:hidden  tr"
          >
            <div className=" [background:linear-gradient(0deg,rgba(255,255,255,0.2)_0%,rgba(255,255,255,0.2)_100%),rgba(0,0,0,0.05)] backdrop-blur-[15px] p-6 rounded-[10px] transition-all duration-75 ease-in-out">
