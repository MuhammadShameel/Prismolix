...
const Footer = () => {
  return (
    <footer className=" px-3 md:px-4 lg:px-5 overflow-hidden">
      {/* Top Ticker/Marquee */}
        ...
        <div className="flex flex-col">
          <div className="relative py-8 lg:py-24">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row justify-between lg:pb-[50px] md:pb-[40px] pb-[30px]">
                ...
                <div className="flex gap-3">
                  {socialLinks.map((social, index) => (
                    <Link
                      ...
                      className="rounded-full border border-gray-300 lg:p-2 p-1 text-gray-600 transition-colors hover:bg-gray-100 hover:text-black"
                    >
                      {social.icon}
                    </Link>
                  ))}
              ...
              {/* Middle Section */}
              <div className="img-wrapper absolute left-[50%] lg:translate-x-[-50%] -z-1 lg:right-auto md:right-0 lg:w-auto  md:bottom-auto -bottom-5 md:w-[40%] sm:w-[75%] w-[90%]">
                <Image
                  src={FooterShape}
            ...
            <div className="prismolix-text relative z-10 w-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                // width="1320"
                // height="180"
